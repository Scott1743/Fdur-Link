...
module UsersHelper
  def signup_error
    ...
    if @signup_errors[:email].blank?
    	@signup_errors[:email][:a]=""
    end
    if @signup_errors[:password].blank?
    	@signup_errors[:password][:a]=""
    end
    if @signup_errors[:password_confirmation].blank?
    	@signup_errors[:password_confirmation][:a]=""
    end
    @signup_errors
  end
end
